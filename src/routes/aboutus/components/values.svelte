<section class="h-full my-10 ">
    <div class="lg:max-w-[1100px] xl:max-w-[80vw] flex ml-auto mr-auto  flex-col-reverse  lg:flex-row text-justify  items-center justify-center">
        <div data-aos="fade-up" data-aos-once="true" class="basis-1/2 text-neutral-800 flex flex-col  justify-center p-4 m-4">
           <h1 class="text-3xl font-semibold text-center md:text-start "> Core Values</h1>
           <br>
        ...
        <br>
            <p class="md:text-xl text-base text-left">
            THE FOUR <b>CORE VALUES</b> OF CATHERINE ARE

             <b class="px-1">ACADEMIC EXCELLENCE,</b>
             <b class="px-1">DISCIPLINE,</b>
             <b class="px-1">VALUE EDUCATION,</b>
             <b class="px-1">ACCOUNTABILITY.</b>
        </p>
        </div>
