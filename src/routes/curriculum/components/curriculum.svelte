<section class="h-full my-10">
    <div class="lg:max-w-[1100px] xl:max-w-[80vw] flex ml-auto mr-auto  flex-col-reverse  lg:flex-row text-justify  items-center justify-center">
        ...
        <h1 class="text-3xl font-semibold text-center md:text-start "> CBSE</h1>
        <br>
        ...
        <p class="md:text-xl text-base">
            It also includes physical education and health education, as well as opportunities for students to engage in extracurricular activities such as sports and music. The goal of the CBSE curriculum is to provide students with the knowledge and skills they need to succeed in higher education and in their future careers.      </p>
    </div>
    <div data-aos="zoom-in" data-aos-once="true" class="basis-1/2 p-4 m-4 md:max-w-[600px] ">
        <img src="/cbse.jpg" alt="" class="rounded-[25%] sticky ">
    </div>
 </div>
</section>