            ...
            <svg
             ...
             preserveAspectRatio="xMidYMid meet">
                ...
                fill="rgb(66, 66, 66)" stroke="none">
                    ...
                    <path d="M325 590 l-90 -90 92 -92 c73 -73 95 -90 105 -80 10 10 -2 27 -57 82
...
<div class="events-container md:px-4 py-4 pr-8 flex flex-nowrap overflow-x-auto bg-white h-[600px] ">
    ...
    <div class="card  w-[350px] p-2 relative mx-4 " id={`card-${i}`}>
        <div class="cards-grad absolute z-0">
            <div id="grad-1" class="w-[300px]  z-0 absolute top-[-10px] left-[12.5px] rounded-3xl  opacity-0 h-[100px]   bg-gradient-to-r from-cyan-500 to-blue-500 "></div>
            <div id="grad-2" class="w-[270px] -z-10 absolute top-[-20px] left-[30px] rounded-3xl opacity-0  h-[100px]  bg-gradient-to-r from-purple-500 to-pink-500 "></div>
        </div>  
        <div class="card-image-parent rounded-t-3xl relative z-10 overflow-hidden h-[300px] mb-[-120px]"> 
            <img alt="event-image" class="rounded-t-3xl pointer-events-none card-image-child h-[100%] w-[100%] object-cover object-center " src={`${event.image}`}/> 
        </div>
        <div class="card-content h-[350px]  grid items-center  relative z-20 bg-white  rounded-3xl p-6 ">
            ...
            <p class="content-description font-medium text-justify  text-gray-600 ">{event.description}
            </p>
...
<style>
    ...
    .card:hover .content-view , .card:focus .content-view{
