    ...
    <button class="flex flex-row px-6 py-3 rounded-full bg-white hover:bg-gray-900 align-middle justify-between items-center">
       ...
       <span class="align-middle font-medium pl-2 text-xl hover:text-white">Explore our resorces</span>    
        ...
        <div class="flex flex-row items-center justify-center pl-16">
            <svg class="fill-yellow-500 h-[70%] m-2" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
           ...
           <span class=" text-xl font-bold text-black hover:text-yellow-500">Catherine <br> CBSE School</span>
        </div>
<div class="flex flex-row items-center pr-6">
<span class="text-lg font-semibold mr-6 text-black hover:text-yellow-500">Education Resorces</span>
<span class="text-lg font-semibold mr-6 text-black hover:text-yellow-500">Community</span>
<span class="text-lg font-semibold mr-6 text-black hover:text-yellow-500">Admissions</span>
