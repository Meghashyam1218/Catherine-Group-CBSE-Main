<script>
	...
	import { Circ, gsap } from 'gsap/dist/gsap';
	import { ScrollTrigger } from 'gsap/dist/ScrollTrigger';

	onMount(()=>{
		gsap.registerPlugin(ScrollTrigger)
		var hover1 = gsap.to('#svg1 ', {
			duration: 0.5,ease:"cric.out",
			scale: 1
		});
		var hover2 = gsap.to('#svg2 ', {
			duration: 0.5,ease:"cric.out",
			scale: 1
		});
		var hover3 = gsap.to('#svg3 ', {
			duration: 0.5,ease:"cric.out",
			scale: 1
		});
		...
		let highlight1 = document.getElementById('high1');
		let highlight2 = document.getElementById('high2');
		let highlight3 = document.getElementById('high3');

		highlight1.addEventListener('mouseenter', () => {
			hover1.restart(), console.log('enter');
		});
		highlight2.addEventListener('mouseenter', () => {
			hover2.restart(), console.log('enter');
		});
		highlight3.addEventListener('mouseenter', () => {
			hover3.restart(), console.log('enter');
		});
...
<section data-aos="fade-up" class="flex flex-col  max-md:items-center my-20">
	...
	<div
		class="highlights  md:scale-[0.75] lg:scale-[1] lg:gap-2 gap-8 md:flex-row md:flex md:w-[100vw] w-[95vw] lg:w-[95vw] justify-evenly"
	>
		<div class="highlight scale-[.8] md:scale-[1] w-[311px] mx-auto relative">
			...
			<a href="/educators" id="high1" data-aos="fade-up" class="content-h absolute cursor-pointer highs top-[33%] left-[15%] ">
		...
		<div  class="highlight scale-[.8] md:scale-[1] w-[311px] mx-auto relative">
			...
			<a href="/infra" data-aos="fade-up" data-aos-delay="200" id="high2" class="content-h absolute top-[33%] cursor-pointer highs left-[0%] ">
		...
		<div class="highlight scale-[.8] md:scale-[1] w-[311px] mx-auto relative">
			...
			<a href="/curriculum" data-aos="fade-up" data-aos-delay="400" id="high3" class="content-h absolute top-[33%] cursor-pointer highs left-[15%] ">
