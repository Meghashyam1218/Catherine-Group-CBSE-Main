...
<section class="z-[999]   fixed top-0">
    <div in:fade class="w-[100vw] navmain translate-y-[-85px] transition-all duration-500 ease-linear  bg-white h-[70px] md:h-[85px]  pt-[5px] md:pt-[10px] px-[25px] md:px-[24px] xl:px-[42px] {nav === false ? ' rounded-b-none ' : 'rounded-b-[2rem] shadow-md'} ">
        <div class="nav grid">
            <div>
                {#if nav}
                <button 
    ...
    {#if !nav}
    <div out:fade class="w-[100vw] fixed top-0 transition-all duration-500 ease-linear  bg-white h-[70px] md:h-[85px]  pt-[5px] md:pt-[10px] px-[25px] md:px-[24px] xl:px-[42px] ">
        <div class="nav grid">
            <div>
...
<section class="">
    <div class="hero-container relative overflow-hidden  ">
        <div class="fake-border  border-[#f5f5f5]  backdrop-blur-xl border-b-0 lg:border-[20px] md:border-[15px] absolute top-0 lg:h-[120vh]  w-[100%] h-[80vh] md:h-[110vh]">
            ...
            <div class=" mt-[40px] md:mt-[120px] lg:mt-[170px] flex flex-col justify-center h-[70vh] md:h-[70vh]">
                <div class="nav px-5 grid items-center">
                    <div>
                        <button 
                    aria-label="Open main menu "
                    tabindex="1"
            ...
            <div class="flex items-center justify-center pointer-events-none">
                ...
                <div class="header__nav anim--fade--reverse anim--fade--reverse--in lg:flex justify-end items-center hidden">
                    <ul class="header__nav-links flex ">
                        <li class=" {nav === false ? ' hidden  ' : 'inline-block'}">
                            <a href="/resources" aria-label="Educational Resources" tabindex="1" class="link menu-list after:h-[1px] font-medium text-sm xl:text-base text-[#fff]"
                                ><span>Mandatory Disclosure</span></a
                            >
                        </li>
                        <li class="  {nav === false ? ' hidden ' : 'inline-block ml-[24px]'}">
                            <a href="/community" aria-label="Community" tabindex="1" class="link font-medium menu-list after:h-[1px] text-[#fff]"
                                ><span>Contact Us</span></a
                            >
                        </li>
                        <li class=" inline-block ml-[24px]">
                            <a href="/community" aria-label="Community" tabindex="1" class="link flex flex-roww text-[#fff]"
                                ><span class="inline mr-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" />
                                  </svg>
                ...
                <h1 class="dive-text text-5xl mt-5 2xs:text-6xl z-0 md:text-8xl lg:text-9xl text-white text-center font-black">DIVE INTO<br>LEARINING</h1>
                <h1 class="text-white text-sm md:text-2xl font-bold text-center tracking-widest">You are the light of the world</h1>
                <img class="w-[80%] h-[500px] md:h-[80%] max-w-[1500px] object-cover mx-auto mt-6 rounded-[2.5rem]" src="./herobg.png">
            ...
            <a class="z-[-30]  absolute right-[-5px] bottom-[-5px]"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" role="img" class="corner w-[30px] bottom-left"><path d="M35.93,29.89V0H29.84A29.89,29.89,0,0,1,0,29.89H0V36H36v-6.1Z" transform="translate(0.04 0.01)" fill="#f5f5f5"></path></svg></a>
        </div>
       
    
        <div class="relative z-[-50]  w-[100%] lg:h-[120vh] h-[80vh] md:h-[110vh] brightness-[.65]" style="background-image: url(/herobg.png);">
