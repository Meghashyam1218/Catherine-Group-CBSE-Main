<section class="">
	<div
		class="h-[60vh] bg-gradient-to-tl from-emerald-500 to-lime-600 to-current rounded-[2rem] m-4 flex flex-col justify-center items-center md:items-start"
	>
    ...
    <div class="w-[75vw] lg:w-[60vw] ml-auto mr-auto  mt-12">
        <h1 class="text-4xl md:text-5xl font-semibold text-green-900">Dive into the new Ocean School experience! </h1>
        <br>
        <br>
